// Templates organizados por categoria - compartilhado entre Home e Generate
...
export const templateCategories: TemplateCategory[] = [
  {
    title: "Professional",
    description: "Retratos profissionais e corporativos",
    templates: [
      {
  ...
  },
  {
    ...
    description: "Ambientes de consultório e terapia",
    templates: [
      {
        id: "therapy-office", 
        title: "Modern Office",
  ...
  },
  {
    ...
    description: "Especialidades em psicologia clínica",
    templates: [
      {
  ...
  },
  {
    ...
    description: "Bem-estar e práticas integrativas",
    templates: [
      {
...
export const getCategoryBySlug = (slug: string): TemplateCategory | undefined => {
  return templateCategories.find(category => 
    category.title.toLowerCase().replace(/\s+/g, '-') === slug
  );
};